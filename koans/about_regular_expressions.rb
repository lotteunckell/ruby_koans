...
class AboutRegularExpressions < Neo::Koan
  ...
  # THINK ABOUT IT:
  #
  # Explain the difference between a character class ([...]) and an
  # alternation (|).
  #
  # character class tries to match each character at the specified position
  # alternation checks entire string for every option
